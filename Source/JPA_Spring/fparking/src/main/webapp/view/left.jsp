...
<div class="navbar-default sidebar" role="navigation">
	...
	<div class="sidebar-nav navbar-collapse">
		<ul class="nav" id="side-menu">
			...
			<li><a href="#"><i class="fa fa-car"></i> Quản lý lái xe<span class="fa arrow"></span></a>
			...
			<li><a href="#"><i class="fa fa-ruble"></i> Quản lý bãi xe<span class="fa arrow"></span></a>
				<ul class="nav nav-second-level">
			...
			<li><a href="#"><i class="glyphicon glyphicon-usd"></i> Quản lý
				...
				<ul class="nav nav-second-level">
					<li><a href="/business/revenue/commission">Doanh thu chiếu khấu</a></li>
					...
					<li><a href="/business/feedback">Quản lý phản hồi người dùng</a></li>
				</ul> <!-- /.nav-second-level --></li>
			<!-- ===============Nghiep vu Start================= -->
